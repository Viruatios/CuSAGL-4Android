...
4. Record plan-ownership rules: `AGENTS.md` is updated only for major project changes (structure changes, new key classes/methods) or by explicit command; concrete requirement plans live in `CopilotDocs/stepX/plan.md`.
